...
- **13 of 15 patterns built so far**, every one at 100% JaCoCo instruction and branch coverage
...
13 built so far: from-scratch implementation, a real-scenario implementation, its own README,
...
| [Proxy](structural/proxy) | Structural | Caching an expensive external credit-score bureau lookup |
...
| [Command](behavioral/command) | Behavioral | Replayable batch processing queue (millions of records/day) |
...
| [State](behavioral/state) | Behavioral | Transaction lifecycle (PENDING → PROCESSING → SETTLED/FAILED) |
